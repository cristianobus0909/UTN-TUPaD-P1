...
print("Moda unica (valor mas comun) de datos discretos o nominales: ", moda)
print("Mediana (valor central) de los datos: ", mediana)
print("Media aritmetica («promedio») de los datos: ", media)
...
"""
magnitud = int(input("Ingrese la magnitud de un terremoto en escala de Richter"))
if magnitud < 3:
    print("Imperceptible")
...
|Periodo del año                      | Estación en el hemisferio norte                |  Estación en elhemisferio sur|
|---------------------------------------------------------------------------------------------------------------------|
|Desde el 21 de diciembre             |                                                |                              |
|hasta el 20 de marzo (incluidos)     |  Invierno                                      |  Verano                      |
|                                     |                                                |                              |
...
mes = int(input("Ingrese el mes del año (1 al 12): "))
